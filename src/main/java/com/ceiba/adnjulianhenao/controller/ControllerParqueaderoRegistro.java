...
import com.ceiba.adnjulianhenao.service.ServiceParqueaderoRegistro;

@RestController
@RequestMapping("/v5")
public class ControllerParqueaderoRegistro {

	@Autowired
	@Qualifier("servicioParqueaderoRegistro")
	private ServiceParqueaderoRegistro serviceParqueaderoRegistro;
