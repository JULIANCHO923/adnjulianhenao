...
public class ServiceVehiculo {
	...
	public Vehiculo obtenerporId(int idVehiculo){
		return converterVehiculo.convertirVehiculo(repositoryVehiculo.findById(idVehiculo)); 		
	}
	...
	public List<Vehiculo> obtenerPorIdTipoVehiculo(int tipoVehiculo){
		return converterVehiculo.convertirLista(repositoryVehiculo.findByTipoVehiculo(tipoVehiculo)); 		
	}
